...
│   ├── SWE-bench-Verified.md    # SWE-bench 人工验证子集
│   ├── SWE-bench-Pro.md         # SWE-bench 专业级
│   ├── LiveCodeBench.md         # 实时编程竞赛题
│   ├── BigCodeBench.md          # 大规模代码评测
│   └── CodeForces.md            # 竞赛编程评测
├── 05-long-context/
│   ├── MRCR.md                  # 多轮共指消解
│   ├── AA-LCR.md                # 长上下文推理
│   └── RULER.md                 # 长文本检索与推理
...
│   ├── BFCL.md                  # 伯克利函数调用评测
│   ├── Tau2.md                  # 多轮代理评测
│   ├── BrowseComp.md            # 浏览器代理评测
│   ├── OSWorld.md               # 操作系统代理评测
│   ├── WebArena.md              # Web 代理评测
│   └── GDPval.md                # GDP 验证评测
├── 13-domain-specific/
│   ├── HealthBench.md           # 医疗评测
...
├── 14-competition-math/
│   ├── AIME.md                  # 美国数学邀请赛
│   ├── HMMT.md                 # 哈佛-麻省理工数学锦标赛
│   └── FrontierMath.md          # 前沿数学评测
└── 15-eval-frameworks/
    ├── 评测框架与工具.md         # 评测框架与工具总览
    └── 新兴benchmark趋势.md      # 新兴 Benchmark 趋势
```
...
| 推理 | GPQA, ARC-AGI, ARC-AGI-2, HLE | 深度推理与泛化 |
| 数学 | GSM8K, MATH, AIME | 数学问题求解 |
| 编程 | HumanEval, SWE-bench, LiveCodeBench, CodeForces, SWE-bench Verified | 代码生成与软件工程 |
...
| 多模态 | MMMU, MMMU-Pro, VQAv2 | 图文联合理解 |
| 对话生成 | Chatbot Arena, WildBench | 人类偏好对齐 |
| 智能体 | GAIA, BFCL, RE-Bench, BrowseComp, OSWorld, WebArena | 代理工具使用能力 |
| 竞赛数学 | AIME, HMMT, FrontierMath | 竞赛级数学求解 |
